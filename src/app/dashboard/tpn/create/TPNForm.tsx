                    ...
                    <div className="flex w-full">
                        <div className="w-full mx-4 ">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4 pb-2 border-b">
                                ...
                                <p className="font-bold">Product Cost: <span>0.00</span></p>
                                <p className="font-bold">Shipping Cost: <span>0.00</span></p>
                                <p className="font-bold">Total Cost: <span>0.00</span></p>
